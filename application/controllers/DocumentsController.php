			...
			if (isset($typeFile)) {
				...
				if (file_exists($fileName)) {
					...
					$this->getResponse()
		                ...
		                ->setHeader('Content-type', $this->_getTypeMime($typeFile), true)
					...
					throw new Zend_Exception('Le fichier ' . $fileName . ' est inexistant');
					$this->_forward('index', 'competences');
				}
				
			} else {
				throw new Zend_Exception('Type ' . $typeFile . ' non trouvé');
				$this->_forward('index', 'competences');
			}
